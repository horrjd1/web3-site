...
def createCountries():
   ...
   Country(name='United States of America', abbreviation='USA', population='331000000').save()
...
def add_country():
   ...
   Country(name=newName, abbreviation=newAbbreviation, population=newPopulation).save()
